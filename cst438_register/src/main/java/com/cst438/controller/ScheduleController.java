...
@RestController
@CrossOrigin(origins = {"http://localhost:300", "https://registerf-cst438.herokuapp.com/"})
public class ScheduleController {
	...
	public ScheduleDTO.CourseDTO addCourse( @RequestBody ScheduleDTO.CourseDTO courseDTO  ) { 
	  ...
	  @PostMapping("/student")
	   @Transactional
	   public ScheduleDTO.CourseDTO addStudent( @RequestBody ScheduleDTO.CourseDTO courseDTO  ) { 
